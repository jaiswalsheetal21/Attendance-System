    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "C:\\Users\\jaisw\\OneDrive\\Desktop\\Attendance-Management-system-using-face-recognition\\attendance"
            ...
            def attf():
                ...
                subprocess.Popen(
                     r'explorer /select, "C:\\Users\\jaisw\\OneDrive\\Desktop\\Attendance-Management-system-using-face-recognition\\attendance(Manually)"'
                )
